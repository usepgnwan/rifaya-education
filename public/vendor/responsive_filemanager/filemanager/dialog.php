...
function filenameSort($x, $y)
{
    ...
    if ($x['is_dir'] !== $y['is_dir']) {
        ...
        if ($descending) {
            return strcmp($y['file_lcase'], $x['file_lcase']);
        } else {
            ...
            <?php if($config['multiple_selection']){ ?><div class="selector">
                ...
                <div class="img-precontainer">
                    ...
                    <div class="img-container">
                        <img class="<?php echo $show_original ? "original" : "" ?><?php echo $is_icon_thumb ? " icon" : "" ?>" data-src="<?php echo str_replace('../../../tiny_filemanager/', '/tiny_filemanager/', $src_thumb);?>">
                    </div>
                </div>
