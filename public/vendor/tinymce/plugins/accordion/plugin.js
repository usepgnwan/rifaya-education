...
(function () {
    ...
    const insertAccordion = editor => {
      ...
      const accordionSummaryHtml = `<summary class="${ accordionSummaryClass } flex items-center justify-between w-full  p-5 rtl:text-right text-gray-500 border border-b-1 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3 font-bold">${ summaryText }</summary>`;
      const accordionBodyHtml = `<${ accordionBodyWrapperTag } class="${ accordionBodyWrapperClass } mce-accordion-body p-5 border border-b-1 border-gray-200 dark:border-gray-700 dark:bg-gray-900"><p>${ bodyText }</p></${ accordionBodyWrapperTag }>`;
