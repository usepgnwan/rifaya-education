    ...
    <div id="drawer-disabled-backdrop" class="fixed top-[64px] left-0 h-screen p-4 overflow-y-auto transition-transform  bg-[#FABE0E] max-lg:w-64 sm:w-1/5 dark:bg-gray-800 z-20 ">
        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                ...
                <x-partials.dashboard.side-link href="{{ route('account.tes') }}" :active="request()->routeIs('account.tes')" :icon="'icon-[streamline--pie-chart-solid]'">
                ...
                <x-partials.dashboard.side-link :multi="'true'"  href="{{ route('home') }}" :active="request()->routeIs('account.tes*')" :icon="'icon-[streamline--pie-chart-solid]'" class=" w-full ">
                    <span class="ms-3" > <x-slot name="title">tes haha</x-slot> </span>
                    <!-- multi link -->
                    <x-slot name="link">
