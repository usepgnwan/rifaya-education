                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ms-1 font-medium text-gray-700 hover:text-[#FABE0E] md:ms-2 dark:text-gray-400 dark:hover:text-white">Blog</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            <span class="icon-[ep--arrow-right] text-slate-700 mt-2"></span> &nbsp;
                            <span class="ms-1 font-medium text-gray-500 md:ms-2 dark:text-gray-400">Artikel</span>
                        </div>
                    </li>
                </ol>
            </nav>
